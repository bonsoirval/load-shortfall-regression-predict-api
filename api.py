...
static_model = load_model(path_to_model='assets/trained-models/load_shortfall_simple_lm_regression.pkl')
...
def model_prediction():
    ...
    # return render_template('result.html', output=output) # "Working"
